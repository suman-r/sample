...
def flames(f, g, b, re, cr, your):
    ...
    while len(f) != 1:
        ...
        i = -1
    relation = f[0]
    print(your+' + '+crush+' = '+relation)
    print("\n\n\n\n\n\n")
    ff = Figlet(font='slant')
    print(ff.renderText(relation))
    print("\n\n\n\n\n\n")
...
while(flag == 0):
    ...
    if key == '0':
        ...
        your = input('ENTER YOUR NAME: ').strip().upper()
        print()
        b = list(your)
        re = list(your)
        g = input('ENTER YOUR CRUSH: ').strip().upper()
        print()
        cr = list(g)
        ...
        print()
        print('if you want to play again'.upper())
        print()
        print('enter 0')
        print()
        print('again enter enter a valid key'.upper())
        print()
        flag = input()
        if flag != '0':
            break
print(ss.renderText('BYE BYE'))
print()
ff = Figlet()
